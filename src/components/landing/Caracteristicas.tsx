...
export const Caracteristicas = () => {
    return (
        <div className="container-caracteristicas">
            ...
            <div className="tab-content-caracteristicas content1"></div>
            <div className="tab-content-caracteristicas content2"></div>
            <div className="tab-content-caracteristicas content3"></div>
            <div className="tab-content-caracteristicas content4"></div>

            <div className="tabs-caracteristicas">
                <label htmlFor="tab1" className="tab-title-caracteristicas">
                    <h3 className='tittle_h3' >Coordinación</h3>
