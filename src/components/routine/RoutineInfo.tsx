...
import { Level, Calendar as CalendarIcon, Time, Human } from '../icons/index.js';
...
export const RoutineContainer = (props: RoutineContainerProps) => {
  ...
  return (
    <div className="routine__container">
      ...
      <Btn btnClass="routine_cta" text="Continuar entrenando" onClick={() => navigate(`/routine/${id}`)} />
    </div>
  );
};
